...
public class LeafNode extends AbstractNode
{
    ...
    @Override
    public void intersect(Ray rayView, Stack<Matrix4f> modelView, HitRecord hitRecord, Map<String, util.TextureImage> textureImages) {
        ...
        if (objInstanceName.equals("sphere"))
        {
            ...
            if ((b*b-4*a*c)>=0)
            {
                ...
                if (t<hitRecord.time)
                {
                    ...
                    TextureImage TI = textureImages.get(this.textureName);
                    Vector4f start = rayObject.start;
        ...
        else if (objInstanceName.equals("box"))
        {
            ...
            if ((tmin<tmax) && (tmax>0))
            {
                ...
                if (t<hitRecord.time) {
                    ...
                    Vector4f pointInLeaf = new Vector4f(rayObject.start.x + t * rayObject.direction.x,
                            rayObject.start.y + t * rayObject.direction.y,
                            rayObject.start.z + t * rayObject.direction.z,
                            1);
