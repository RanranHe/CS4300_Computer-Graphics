...
public interface IScenegraph<VertexType extends IVertexData>
{
    ...
    /**
     * return color[][]: all colors used to map into image
     * @param width width of window
     * @param height height of window
     * @param stack the modelview stack
     * @return
     */
    Color[][] raytrace(int width, int height, Stack<Matrix4f> stack);

    /**
     *  @param Ray
     * @param stack
     */
    Vector4f raycast(ThreeDRay Ray, Stack<Matrix4f> stack);
}
