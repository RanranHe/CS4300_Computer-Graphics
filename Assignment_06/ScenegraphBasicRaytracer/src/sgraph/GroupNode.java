...
public class GroupNode extends AbstractNode {
  ...
  @Override
  public void intersect(Ray ray, Stack<Matrix4f> modelView, HitRecord hitRecord, Map<String, TextureImage> textureImages) {
    for (int i=0;i<children.size();i++)
    {
      children.get(i).intersect(ray,modelView,hitRecord, textureImages);
    }
  }
