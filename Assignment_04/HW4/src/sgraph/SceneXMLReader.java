...
class MyHandler<K extends IVertexData> extends DefaultHandler {
  ...
  public IScenegraph<K> getScenegraph() {
    System.out.println("in reader: the size of texture: " + scenegraph.getTextureSize());
    return scenegraph;
  }
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    switch (qName) {
      ...
      case "material":
        ...
        break;
      case "light":
        System.out.println("detect light in xml");
      ...
      case "ambient":
        sc = new Scanner(data);
        if (setLight) {
          System.out.println("set light's ambient");
